...
const VillageSelectorOrgUnit = ({ variant, VillageSelectorIds, saveGeo, disabled }) => {
  ...
  return (
    <Cascader
      ...
      data={{
        ...
        labels: [
          <AttributeLabel variant={variant} attribute={VillageSelectorIds[0]} />,
          <AttributeLabel variant={variant} attribute={VillageSelectorIds[1]} />,
          <AttributeLabel variant={variant} attribute={VillageSelectorIds[2]} />
        ]
      }}
    />
  );
