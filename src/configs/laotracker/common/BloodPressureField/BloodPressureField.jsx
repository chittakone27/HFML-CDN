    ...
    <div className="blood-pressure-field-row">
      <div style={{ display: "flex", alignItems: "center" }}>
        <div>
          ...
          <DataValueFieldNoBlur dataElement="tVPKjkXrMSB" {...props.tVPKjkXrMSB} disabled={!layout.eventFormEditing} />
        </div>
        <div style={{ alignSelf: "flex-end", height: 36, fontSize: 25 }}>&nbsp;/&nbsp;</div>
        <div>
          <DataValueLabel dataElement="TThw3XArMBK" />
          <DataValueFieldNoBlur dataElement="TThw3XArMBK" {...props.TThw3XArMBK} disabled={!layout.eventFormEditing} />
        </div>
