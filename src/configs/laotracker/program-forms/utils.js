...
export const calculateDiff = (startDate, endDate) => {
  ...
  monthDiff = moment(endDate).subtract(yearDiff, "years").diff(moment(startDate), "months");
  dayDiff = moment(endDate).subtract(yearDiff, "years").subtract(monthDiff, "months").diff(moment(startDate), "days");
  return {
