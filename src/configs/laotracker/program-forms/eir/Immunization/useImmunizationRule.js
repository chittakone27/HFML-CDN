...
const useImmunizationRule = () => {
  ...
  useEffect(() => {
    ...
    if (dob && eventDate) {
      ...
      // calculate age in month
      const ageInMonth = convertEvDate.diff(convertDob, "months");
    ...
    if (dataValues?.[DATA_ELEMENT_IDS.HEPB0_LESS_THAN_7DAYS])
      hiddenFields[DATA_ELEMENT_IDS.HEPB0_LESS_THAN_24H] = true;
    //hide OPV1 and PCV1 if Penta1 && IPV1 are checked
    if (
      dataValues?.[DATA_ELEMENT_IDS.PENTA_1] &&
      dataValues?.[DATA_ELEMENT_IDS.IPV_1]
    ) {
      hiddenFields[DATA_ELEMENT_IDS.OPV_1] = true;
      hiddenFields[DATA_ELEMENT_IDS.PCV_1] = true;
    }
    //hide OPV2 and PCV2 if Penta1 && IPV1 are checked
    if (
      dataValues?.[DATA_ELEMENT_IDS.PENTA_2] &&
      dataValues?.[DATA_ELEMENT_IDS.IPV_2]
    ) {
      hiddenFields[DATA_ELEMENT_IDS.OPV_2] = true;
      hiddenFields[DATA_ELEMENT_IDS.PCV_2] = true;
    }
    ...
    //hide MR2 before MR1 is given
    if (!isGiven(DATA_ELEMENT_IDS.MR_1) && !dataValues?.[DATA_ELEMENT_IDS.MR_1])
      hiddenFields[DATA_ELEMENT_IDS.MR_2] = true;
    ...
    if (previousEvents?.length) {
      ...
      //hide OPV1 if IPV1 is checked
      hideIfGiven(DATA_ELEMENT_IDS.OPV_1, isGiven(DATA_ELEMENT_IDS.IPV_1));
      //hide PCV1 if IPV1 is checked
      hideIfGiven(DATA_ELEMENT_IDS.PCV_1, isGiven(DATA_ELEMENT_IDS.IPV_1));
      //hide OPV2 if IPV2 is checked
      hideIfGiven(DATA_ELEMENT_IDS.OPV_2, isGiven(DATA_ELEMENT_IDS.IPV_2));
      //hide PCV2 if IPV2 is checked
      hideIfGiven(DATA_ELEMENT_IDS.PCV_2, isGiven(DATA_ELEMENT_IDS.IPV_2));
      ...
      hideIfGiven(DATA_ELEMENT_IDS.IPV_1);
      ...
      hideIfGiven(DATA_ELEMENT_IDS.HPV);
    }
