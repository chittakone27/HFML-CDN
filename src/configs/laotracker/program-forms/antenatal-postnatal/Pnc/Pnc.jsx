...
const Pnc = () => {
  ...
  const foundProgramStage = program.programStages.find((ps) => ps.id === "huYWjrG6A1C");
          ...
          {pss.dataElements.map((de) => {
            ...
            switch (de.id) {
              ...
              case "TThw3XArMBK":
                return null;
              default:
                return <Row dataElement={de.id} key={de.id} disabled={disabledFields.includes(de.id)} {...props[de.id]} />;
            }
          })}
        </div>
      );
