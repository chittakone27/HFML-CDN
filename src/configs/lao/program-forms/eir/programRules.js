const rules = [
  ...
  //DONE
  {
    ...
    id: "wo05G4z4nEu",
    condition:
      "d2:hasValue(A{Date of Birth}) && d2:daysBetween( A{Date of Birth} , V{enrollment_date}) >=0",
    programRuleActions: [
      {
  ...
  //Birth details
  {
    ...
    id: "k6D2fw2c294",
    condition:
      "((#{gestationalAge} <= 28) || (#{gestationalAge} < 50 && #{gestationalAge} > 42)) && d2:hasValue('gestationalAge')",
    programRuleActions: [
      {
  ...
  //DONE
  {
    ...
    id: "Hy6qfxth6ki",
    condition:
      "(d2:daysBetween(A{Date of Birth},  V{event_date} )>1) && !d2:hasValue(#{bcgprev}) && !d2:hasValue(#{BCG})",
    programRuleActions: [
      {
        programRuleActionType: "SHOWWARNING",
