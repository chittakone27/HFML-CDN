...
const dataElementConfigs = addTotalConfigs([
  ...
  [
    { display: "text", text: "Ps-", style: disableStyle },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "vbXYCi3iKZm" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "izEbukxm8oa" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "DCLoTNwSGT8" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "Dc51iOEY0Rm" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "QpAMzshVzjL" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "JoCUc64LLdN" },
    { display: "text", text: "0", style: totalStyle },
  ],
  [
    { display: "text", text: "EP", style: disableStyle },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "oUok8xYQcAq" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "j3AZcMNM3y6" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "b1IQfgcfneL" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "Gc9KGu3ay4B" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "WndvDT8PPD1" },
    { cc: "TiHjDIadDIL", coc: "lmbxvugTvKr", dsde: "f67juSk1R5M" },
    { display: "text", text: "0", style: totalStyle },
  ],
  [
