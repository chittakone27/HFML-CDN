...
const EventDateFieldWithTime = ({ helpers, disabled, type, minDate, maxDate }) => {
  ...
  return (
    <div className="input-field-container">
      <Input
        ...
        value={currentEvent[type ? type : "eventDate"] ? currentEvent[type ? type : "eventDate"] : ""}
        accept={async (value) => {
...
export default EventDateFieldWithTime;
